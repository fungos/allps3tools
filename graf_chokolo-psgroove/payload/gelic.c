...
int gelic_init(void)
{
	...
	result = mm_map_lpar_memory_region(0, MM_EA2VA(GELIC_DMA_BASE), dma_lpar_addr,
		GELIC_DMA_SIZE, GELIC_DMA_PAGE_SIZE, 0, 0);
	if (result != 0)
		return result;
...
int gelic_recv_data(void *data, u64 max_size)
{
