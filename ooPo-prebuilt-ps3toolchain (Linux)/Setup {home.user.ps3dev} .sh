...
# Soon to me moved to https://github.com/Goblom/ooPo-Pre.Comp.ps3toolchain(Linux)
# Run this every time you start the Terminal
# Change {User} to the username that you are on
